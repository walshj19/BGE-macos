...
// Our vertices. Thee consecutive floats give a 3D vertex; Three consecutive vertices give a triangle.
...
void CubeTest::Draw() {
    ...
    glm::mat4 Model      = glm::mat4(1.0f);
    // Our ModelViewProjection : multiplication of our 3 matrices
    glm::mat4 MVP        = Projection * View * Model; // Remember, matrix multiplication is the other
